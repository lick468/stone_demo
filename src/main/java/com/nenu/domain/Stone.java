...
public class Stone implements Serializable {
	...
	private Date stone_purchdate;//采购日期
	private int stone_seqno;//序号
	private String stone_loosdofty;//裸石厂
	private String stone_supplierName;//供应商
	private String stone_mainName;//主石名
	private String stone_mainStoneNo;//主石编
	private String stone_spec;//规格
	private int stone_mainNumber;//主石数
	private double stone_mainWeight;//主石
	private double stone_mainPrperct;//主石价
	private double stone_mainPramt;//主石额

	private String stone_substoNo;//副石编
	private String stone_substoName;//副石名
	private double stone_substoWgt;//副石
	private int stone_substoNumber;//副石数
	private double stone_substoPrperct;//副石价
	private double stone_substoPramt;//副石额

	private String stone_shape;//形状
	private String stone_color;//颜色
	private String stone_clarity;//净度
	private String stone_color2;//颜色2
	private String stone_clarity2;//净度2
	private String stone_cut;//切工
	private String stone_fluorescence;//荧光
	private String stone_symmetry;//对称性
	private String stone_polish;//抛光
	private double stone_diameter;//直径
	private double stone_height;//高度
	private double stone_tablewidth;//台宽比
	private String stone_preparer;//经手人
	private String stone_porter;//接货人
	private String stone_comments;//备注
	private String stone_channelNo;
	private int stone_reserved1;//是否退石
	private String stone_reserved2;//
	private String stone_GIA;//GIA证书号
	...
	public Stone(String stone_ID, Date stone_purchdate, int stone_seqno, String stone_loosdofty,
