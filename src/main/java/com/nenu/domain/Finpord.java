...
public class Finpord implements Serializable {
	...
	public Finpord( String finpord_ID,int finpord_seqno, long finpord_procordNo, String finpord_barcode, Date finpord_inboundate, String finpord_supplier, String finpord_styno, String finpord_quality, String finpord_name, int finpord_ringsz, int finpord_multi, double finpord_tagedpr, double finpord_goldwgt, double finpord_merchwgt, String finpord_counter, String finpord_catagory,
