...
public interface StoneAnalysisService {
	...
	List<StoneAnalysis> findStoneBySupplier(Map<String, Object> params);	
	List<StoneAnalysis> findStoneBySupplierFor711(Map<String, Object> params);
	...
	List<StoneAnalysis> findStoneByCounter(Map<String, Object> params);
	List<StoneAnalysis> findStoneByCounterFor743(Map<String, Object> params);
	
	List<StoneAnalysis> findStoneByArea(Map<String, Object> params);
	List<StoneAnalysis> findStoneFor744(Map<String, Object> params);
	...
	List<StoneAnalysis> findStoneByProduct(Map<String, Object> params);
	...
	int insertStone(StoneAnalysis stone);//插入
	...
	int downloadExcelForIndex(List<StoneAnalysis> list,HttpServletResponse response);//下载index页面的表格
	...
	int downloadExcelForProductNum(List<StoneAnalysis> list,HttpServletResponse response);
	List<StoneAnalysis> findAreaFor742(Map<String, Object> params);//根据销售量找出销量排行的区域
	List<StoneAnalysis> findRoomFor742(Map<String, Object> params);//根据销售量找出销量排行的门店
	List<StoneAnalysis> findCounterFor742(Map<String, Object> params);//根据销售量找出销量排行的柜台
	...
	List<StoneAnalysis> findStoneBySource(Map<String, Object> params);
	List<StoneAnalysis> findStoneForSource(Map<String, Object> params);
	int downloadExcelForIndexSource(List<StoneAnalysis> list,HttpServletResponse response);
	...
	int downloadGraphExcelFor711(String conGraph, HttpServletResponse response);//index711
